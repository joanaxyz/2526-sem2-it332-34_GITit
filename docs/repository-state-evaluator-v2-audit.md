...
- `InspectionEvaluator` remains the separate completion path for read-only diagnostic activities, so diagnostic commands do not become fake state-changing scenarios.
