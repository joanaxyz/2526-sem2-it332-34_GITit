...
MONSTERS: list[dict[str, object]] = [
    {"slug": "monster-01", "label": "Bone Archer", "playback": "projectile", "motif": "blue flaming arrow", "scale": 0.56, "durationMs": 520},
    {"slug": "monster-02", "label": "Bone Blacksmith", "playback": "target", "motif": "blue flame ground crack", "scale": 0.82, "durationMs": 780},
    {"slug": "monster-03", "label": "Bone Demon", "playback": "projectile", "motif": "blue flaming meteor", "scale": 0.62, "durationMs": 660},
    {"slug": "monster-04", "label": "Bone Ghost", "playback": "projectile", "motif": "blue flame ghost skull", "scale": 0.58, "durationMs": 600},
    {"slug": "monster-05", "label": "Bone Lancer", "playback": "target", "motif": "blue flame pierce", "scale": 0.78, "durationMs": 720},
    {"slug": "monster-06", "label": "Bone Necromancer", "playback": "target", "motif": "skeleton hands", "scale": 0.84, "durationMs": 860},
    ...
    {"slug": "monster-09", "label": "Floating Skull", "playback": "target", "motif": "blue flame rain", "scale": 0.86, "durationMs": 880},
    {"slug": "monster-10", "label": "Ghost Lady", "playback": "target", "motif": "blue flame chains", "scale": 0.84, "durationMs": 900, "backLayer": True},
    {"slug": "monster-11", "label": "Lich King", "playback": "target", "motif": "blue flame stab", "scale": 0.9, "durationMs": 920, "backLayer": True},
    {"slug": "monster-12", "label": "Two Headed Hound", "playback": "target", "motif": "blue wolf fang bite", "scale": 0.74, "durationMs": 700},
    {"slug": "monster-13", "label": "Undead Clown", "playback": "projectile", "motif": "carnival curse bomb", "scale": 0.6, "durationMs": 620},
...
def process_monster(spec: dict[str, object]) -> dict[str, object]:
    ...
    diagnostics: dict[str, object] = {"front": make_sheet(raw_path, out_path, playback)}
    layers = [
        {
    ...
    if playback == "target":
        manifest["anchor"] = spec.get("anchor", "center")
