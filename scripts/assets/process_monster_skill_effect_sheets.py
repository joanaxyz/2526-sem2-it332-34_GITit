...
MONSTER_ROOT = (
    ROOT / "frontend" / "public" / "cosmetics" / "story-worlds" / "arcane-spire" / "monsters"
)
...
MONSTERS: list[dict[str, object]] = [
    ...
    {
        "slug": "monster-02",
        "label": "Bone Blacksmith",
        "playback": "target",
        "motif": "blue flame ground crack",
        "scale": 0.82,
        "durationMs": 780,
        "anchor": "feet",
    },
    ...
    {
        "slug": "monster-06",
        "label": "Bone Necromancer",
        "playback": "target",
        "motif": "skeleton hands",
        "scale": 0.84,
        "durationMs": 860,
        "anchor": "feet",
    },
    {
        ...
        "label": "Bone Soldier",
        "playback": "target",
        "motif": "blue flame slash",
        "scale": 0.72,
        "durationMs": 680,
    },
    {
        "slug": "monster-08",
        "label": "Cursed Lantern",
        "playback": "target",
        "motif": "blue flame spin",
        "scale": 0.78,
        "durationMs": 760,
        "placement": "caster",
    },
    ...
    {
        "slug": "monster-12",
        "label": "Two Headed Hound",
        "playback": "target",
        "motif": "blue wolf fang bite",
        "scale": 0.74,
        "durationMs": 700,
    },
    {
...
def process_monster(spec: dict[str, object]) -> dict[str, object]:
    ...
    layers = [
        {
            **sprite_entry(
                f"/cosmetics/story-worlds/arcane-spire/monsters/{slug}/effects/skill.png"
            ),
            "layer": "front",
            "scale": spec["scale"],
            "opacity": 1,
    ...
    if spec.get("backLayer"):
        ...
        layers.insert(
            ...
            {
                **sprite_entry(
                    f"/cosmetics/story-worlds/arcane-spire/monsters/{slug}/effects/skill-back.png"
                ),
                "layer": "back",
...
def main() -> None:
    ...
    write_json_lf(
        MONSTER_ROOT / "_skill-effects-manifest.json",
        {
            ...
            "fps": FPS,
            "monsters": {
                str(spec["slug"]): manifest
                for spec, manifest in zip(MONSTERS, manifests, strict=False)
            },
        },
    )
