...
command history to avoid re-querying CommandLog on every submit. The cache key
pairs the session id with a monotonically growing count (attempts / log count)
