...
def progress_rule_counts(outcome, initial_outcome) -> tuple[int, int]:
    ...
    Progress should represent work earned after the initial state, so subtract
    the multiset of initially-passing rules from both the current passed set and
    the total rule set.
    """
