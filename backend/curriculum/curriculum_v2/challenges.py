...
def _details(before: str, after: str, *, current: str | None = None, risk: str | None = None) -> list[dict[str, str]]:
    rows = [
...
def _scenario(story: str, task: str, *, before: str, after: str, current: str | None = None, risk: str | None = None, constraints: list[str] | None = None) -> dict[str, Any]:
    return {
        "schema_version": 3,
        "story": story,
        "task": task,
...
def variant(
    ...
    *,
    ...
    return {
        ...
        "hint_set_template": [],
        "scaffold_policy_template": {"hints": "contextual", "answer": "never", "diagram": "primary"},
    }
...
def level(
    ...
    *,
    ...
    uses_adventure_quests: list[str],
    current: str | None = None,
    risk: str | None = None,
    ...
    return {
        ...
        "uses_adventure_quests": uses_adventure_quests,
...
CLONE_REMOTE = {
    ...
    "commits": [
        ...
        commit("r1", "Add app shell", ["r0"], {"README.md": "Git-it starter\n", "src/app.py": "print('hello')\n"}),
        commit("r2", "Add testing notes", ["r1"], {"README.md": "Git-it starter\n", "src/app.py": "print('hello')\n", "TESTING.md": "Run pytest\n"}),
        commit("r3", "Prepare login starter", ["r1"], {"README.md": "Git-it starter\n", "src/app.py": "print('hello')\n", "src/login.py": "TODO\n"}),
    ],
}

SNAPSHOT_BASE = [
    commit("c0", "Initial app shell", [], {"README.md": "Portal\n", "src/app.py": "print('hello')\n"}),
]
...
BRANCH_LONG = [
    *BRANCH_BASE,
    commit("c2", "Add dashboard", ["c1"], {"README.md": "Portal\n", "src/app.py": "print('hello')\n", "src/dashboard.py": "cards=[]\n"}),
]

MERGE_BASE = [
    commit("c0", "Create portal", [], {"README.md": "Portal\n", "src/app.py": "shell\n"}),
    commit("m1", "Polish main shell", ["c0"], {"README.md": "Portal\n", "src/app.py": "shell\n", "docs/release.md": "draft\n"}),
    commit("f1", "Add quest menu", ["c0"], {"README.md": "Portal\n", "src/app.py": "shell\n", "src/menu.py": "quests=[]\n"}),
]
CONFLICT_HISTORY = [
...
RECOVERY_HISTORY = [
    commit("c0", "Initial portal", [], {"README.md": "Portal\n"}),
    commit("c1", "Add app shell", ["c0"], {"README.md": "Portal\n", "src/app.py": "shell\n"}),
    commit("c2", "Break login route", ["c1"], {"README.md": "Portal\n", "src/app.py": "shell\n", "src/login.py": "broken=True\n"}),
]

PATCH_HISTORY = [
    commit("c0", "Base project", [], {"README.md": "base\n"}),
    commit("r1", "Prepare release", ["c0"], {"README.md": "base\n", "release.md": "ready\n"}),
    commit("b1", "Fix login crash", ["c0"], {"README.md": "base\n", "src/login.py": "fixed=True\n"}),
    commit("b2", "Add noisy experiment", ["b1"], {"README.md": "base\n", "src/login.py": "fixed=True\n", "experiment.txt": "skip\n"}),
]

REMOTE_BASE = [
    commit("c0", "Create portal", [], {"README.md": "Portal\n"}),
    commit("c1", "Local app shell", ["c0"], {"README.md": "Portal\n", "src/app.py": "local shell\n"}),
]
REMOTE_FIXTURE_AHEAD = {
    "branches": {"origin/main": "r2"},
    "default_branch": "origin/main",
    "commits": [
        commit("r2", "Remote review note", ["c1"], {"README.md": "Portal\n", "src/app.py": "local shell\n", "review.md": "approved\n"}),
    ],
}
REMOTE_DIVERGED = [
    commit("c0", "Create portal", [], {"README.md": "Portal\n"}),
    commit("c1", "Add app shell", ["c0"], {"README.md": "Portal\n", "src/app.py": "local shell\n"}),
    commit("l2", "Local release note", ["c1"], {"README.md": "Portal\n", "src/app.py": "local shell\n", "release.md": "local\n"}),
    commit("r2", "Remote review note", ["c1"], {"README.md": "Portal\n", "src/app.py": "local shell\n", "review.md": "approved\n"}),
]
    ...
    challenge(
        ...
        [
            level(
                ...
                uses_adventure_quests=["clone-into-named-folder", "inspect-status", "inspect-graph-history"],
                ...
                variants=[
                    variant(
                        ...
                        evaluation=_contract(
                            ...
                            required=["git clone"],
                            graph={"from": "no local DAG", "to": "main and origin/main point to r2"},
            ...
            level(
                ...
                uses_adventure_quests=["clone-specific-branch", "inspect-graph-history"],
                min_counted_commands=1,
                max_counted_commands=3,
                variants=[
                    variant(
                        ...
                        initial=uninitialized(remote_fixtures=CLONE_REMOTE),
                        solution=["git clone -b starter/login https://example.test/git-it/starter.git login-lab"],
                        evaluation=_contract(
                            {
                                "repository_initialized": True,
                            ...
                            graph={"from": "no local DAG", "to": "starter/login follows origin/starter/login at r3"},
            ...
            level(
                ...
                uses_adventure_quests=["clone-shallow-history", "inspect-compact-history"],
                min_counted_commands=1,
                max_counted_commands=3,
                variants=[
                    variant(
                        ...
                        initial=uninitialized(remote_fixtures=CLONE_REMOTE),
                        solution=["git clone --depth 1 https://example.test/git-it/starter.git starter-review"],
                        evaluation=_contract(
                            {
                                "repository_initialized": True,
                                "head_branch": "main",
                                "branch_points_to": {"main": "r2"},
                                "remote_branch_points_to": {"origin/main": "r2"},
                                "rules": [{"type": "commit_count_equals", "count": 1}, meta_equals("last_clone_shallow", True)],
                            },
                            required=["git clone --depth"],
                            graph={"from": "remote history r0 -> r1 -> r2", "to": "local shallow main -> r2"},
    ...
    challenge(
        ...
        [
            level(
                ...
                uses_adventure_quests=["inspect-status", "inspect-working-diff", "stage-one-file", "commit-staged-snapshot"],
                ...
                variants=[
                    variant(
                        ...
                        initial=repo(commits=SNAPSHOT_BASE, working_tree={"README.md": {"status": "modified", "content": "Portal\nSetup instructions\n"}}),
                        solution=["git add README.md", "git commit -m \"Update setup notes\""],
                        evaluation=_contract(
                            {
                                "latest_commit": {"branch": "main", "contains_paths": ["README.md"], "message_contains": ["setup"]},
                                "working_tree_clean": True,
                                "staging_empty": True,
                                "rules": [{"type": "commit_parent_count_equals", "branch": "main", "count": 1}],
                            },
            ...
            level(
                "medium",
                story="A useful app change and a messy local scratch file are present together.",
                ...
                variants=[
                    variant(
                        ...
                        initial=repo(
                            ...
                            working_tree={
                                "src/app.py": {"status": "modified", "content": "print('hello')\nprint('setup')\n"},
                        ...
                        evaluation=_contract(
                            {
                                "latest_commit": {"branch": "main", "contains_paths": ["src/app.py"], "excludes_paths": ["scratch.txt"], "message_contains": ["setup"]},
                                "working_tree_contains": ["scratch.txt"],
                                "staging_empty": True,
                            },
                            required=["git add", "git commit"],
                            forbidden=["git add .", "git add -A"],
                            graph={"from": "main -> c0 with mixed workspace edits", "to": "main -> focused commit; scratch outside DAG"},
            ...
            level(
                ...
                uses_adventure_quests=["stop-tracking-local-file", "commit-staged-snapshot", "inspect-staged-diff"],
                min_counted_commands=2,
                max_counted_commands=6,
                variants=[
                    variant(
                        ...
                        solution=["git rm --cached .env", "git commit -m \"Stop tracking local env\""],
                        evaluation=_contract(
                            {
                                "latest_commit": {"branch": "main", "contains_paths": [".env"], "message_contains": ["env"]},
                                "rules": [
                            ...
                            graph={"from": "main -> c0 with secret in tree", "to": "main -> cleanup commit removing secret from tree"},
    ...
    challenge(
        ...
        [
            level(
                ...
                uses_adventure_quests=["create-and-switch-branch", "stage-one-file", "commit-staged-snapshot"],
                ...
                variants=[
                    variant(
                        ...
                        initial=repo(commits=BRANCH_BASE, branches={"main": "c1"}, working_tree={"src/menu.py": {"status": "untracked", "content": "items=[]\n"}}),
                        solution=["git switch -c feature/menu", "git add src/menu.py", "git commit -m \"Add menu draft\""],
                        evaluation=_contract(
                            {
                                "head_branch": "feature/menu",
                                "branch_points_to": {"main": "c1"},
                                "latest_commit": {"branch": "feature/menu", "contains_paths": ["src/menu.py"], "message_contains": ["menu"]},
                                "working_tree_clean": True,
                                "staging_empty": True,
                            },
                            required=["git switch -c", "git add", "git commit"],
                            graph={"from": "main -> c1", "to": "main -> c1; feature/menu -> new child commit"},
            ...
            level(
                ...
                uses_adventure_quests=["create-branch-at-start-point", "switch-existing-branch", "inspect-graph-history"],
                min_counted_commands=2,
                max_counted_commands=5,
                variants=[
                    variant(
                        ...
                        evaluation=_contract(
                            ...
                            graph={"from": "c0 -> c1 -> c2(main)", "to": "hotfix/login points at c1 while main stays at c2"},
            ...
            level(
                ...
                uses_adventure_quests=["delete-merged-branch", "inspect-graph-history"],
                min_counted_commands=1,
                ...
                variants=[
                    variant(
                        ...
                        initial=repo(commits=BRANCH_LONG, branches={"main": "c2", "review/menu": "c1"}, head="main"),
                        ...
                        evaluation=_contract(
                            ...
                            graph={"from": "main and stale review/menu refs visible", "to": "stale review/menu ref removed"},
    ...
    challenge(
        ...
        [
            level(
                ...
                uses_adventure_quests=["merge-fast-forward-branch", "inspect-graph-history"],
                min_counted_commands=1,
                max_counted_commands=4,
                variants=[
                    variant(
                        ...
                        initial=repo(commits=[MERGE_BASE[0], MERGE_BASE[2]], branches={"main": "c0", "feature/menu": "f1"}, head="main"),
                        ...
                        evaluation=_contract(
                            ...
                            required=["git merge"],
                            graph={"from": "main behind feature/menu", "to": "main fast-forwards to feature/menu"},
            ...
            level(
                ...
                uses_adventure_quests=["merge-with-merge-commit", "inspect-graph-history"],
                min_counted_commands=1,
                max_counted_commands=4,
                variants=[
                    variant(
                        ...
                        initial=repo(commits=MERGE_BASE, branches={"main": "m1", "feature/menu": "f1"}, head="main"),
                        solution=["git merge --no-ff feature/menu"],
                        evaluation=_contract(
                            {
                                "latest_commit": {"branch": "main", "contains_paths": ["src/menu.py"], "message_contains": ["Merge"]},
                                "rules": [
                            ...
                            graph={"from": "two diverged branch tips", "to": "new merge commit joins both histories"},
            ...
            level(
                ...
                uses_adventure_quests=["merge-fast-forward-branch", "choose-their-conflict-side", "continue-resolved-merge", "stage-one-file"],
                min_counted_commands=3,
                ...
                variants=[
                    variant(
                        ...
                        initial=repo(commits=CONFLICT_HISTORY, branches={"main": "m1", "feature/auth-timeout": "f1"}, head="main"),
                        solution=["git merge feature/auth-timeout", "git add src/auth.js", "git merge --continue"],
                        workspace_files=[{"after_command_index": 1, "path": "src/auth.js", "content": "timeout=2500\nmode='strict'\n"}],
                        evaluation=_contract(
                            {
                                "latest_commit": {"branch": "main", "contains_paths": ["src/auth.js"], "message_contains": ["Merge"]},
                                "conflict_free": True,
                                "staging_empty": True,
                                "rules": [
                                    {"type": "commit_is_merge", "branch": "main"},
                                    {"type": "commit_has_parent", "branch": "main", "parent": "m1"},
                                    {"type": "commit_has_parent", "branch": "main", "parent": "f1"},
                                    {"type": "commit_tree_contains", "branch": "main", "tree": {"src/auth.js": "timeout=2500\nmode='strict'\n"}},
                                ],
                            },
                            required=["git merge", "git add", "git merge --continue"],
                            graph={"from": "diverged branches with conflict", "to": "resolved two-parent merge commit"},
                            concepts=["conflict resolution", "staging resolved file", "continue merge"],
                            engine_notes=["Challenge depends on workspace-file edit support between merge and add."],
                        ),
                    )
                ],
            ),
    ...
    challenge(
        ...
        [
            level(
                ...
                uses_adventure_quests=["amend-latest-commit-message", "inspect-compact-history"],
                min_counted_commands=1,
                max_counted_commands=4,
                variants=[
                    variant(
                        ...
                        initial=repo(commits=[commit("c0", "Initial portal", [], {"README.md": "Portal\n"}), commit("c1", "stuff", ["c0"], {"README.md": "Portal\n", "src/login.py": "copy\n"})], branches={"main": "c1"}),
                        solution=["git commit --amend -m \"Add login copy\""],
                        evaluation=_contract(
                            {
                                "latest_commit": {"branch": "main", "contains_paths": ["src/login.py"], "message_contains": ["login"]},
                                "rules": [
                                    {"type": "commit_replaced_by_amend", "old": "c1"},
                                    {"type": "branch_tip_replaces_commit", "old": "c1", "branch": "main"},
                                    {"type": "commit_not_followed_by_extra_commit", "branch": "main"},
                                ],
                            },
                            required=["git commit --amend"],
                            graph={"from": "main -> c1", "to": "main -> replacement commit, not c1 -> extra commit"},
            ...
            level(
                "medium",
                story="The latest local commit is wrong and has not been pushed anywhere.",
                ...
                uses_adventure_quests=["reset-hard-specific-commit", "inspect-reflog-for-recovery"],
                min_counted_commands=1,
                max_counted_commands=4,
                variants=[
                    variant(
            ...
            level(
                ...
                uses_adventure_quests=["revert-shared-commit", "inspect-graph-history"],
                min_counted_commands=1,
                max_counted_commands=5,
                variants=[
                    variant(
                        ...
                        initial=repo(commits=RECOVERY_HISTORY, branches={"main": "c2"}, remote_branches={"origin/main": "c2"}, upstream_tracking={"main": "origin/main"}, remotes={"origin": "https://example.test/team/app.git"}),
                        ...
                        evaluation=_contract(
                            {
                                ...
                                "rules": [
                                    ...
                                    {"type": "commit_parent_equals", "branch": "main", "parent": "c2"},
                                ],
                                "working_tree_clean": True,
                            },
                            required=["git revert"],
                            forbidden=["git reset --hard"],
                            graph={"from": "main/origin-main -> c2", "to": "main -> revert commit after c2; c2 preserved"},
    ...
    challenge(
        ...
        [
            level(
                ...
                uses_adventure_quests=["stash-local-work", "switch-existing-branch"],
                min_counted_commands=2,
                max_counted_commands=5,
                variants=[
                    variant(
                        ...
                        initial=repo(commits=BRANCH_BASE, branches={"main": "c1", "review/menu": "c1"}, head="main", working_tree={"docs/release.md": {"status": "modified", "content": "draft\n"}}),
                        solution=["git stash", "git switch review/menu"],
                        evaluation=_contract(
                            {
                                "head_branch": "review/menu",
                                "working_tree_clean": True,
                                "rules": [{"type": "stash_stack_contains_paths", "paths": ["docs/release.md"]}],
                            },
                            required=["git stash", "git switch"],
                            graph={"from": "HEAD on main with dirty workspace", "to": "HEAD on review/menu; WIP stored outside DAG"},
            ...
            level(
                ...
                uses_adventure_quests=["cherry-pick-one-commit", "inspect-graph-history"],
                min_counted_commands=1,
                max_counted_commands=5,
                variants=[
                    variant(
                        ...
                        initial=repo(commits=PATCH_HISTORY, branches={"release": "r1", "bugfix/login": "b2"}, head="release"),
                        solution=["git cherry-pick b1"],
                        evaluation=_contract(
                            {
                                "latest_commit": {"branch": "release", "contains_paths": ["src/login.py"], "message_contains": ["login"]},
                                "rules": [
                                    {"type": "cherry_pick_created_new_commit", "source": "b1", "branch": "release"},
                                    {"type": "branch_history_excludes", "branch": "release", "commits": ["b2"]},
                                ],
                            },
                            required=["git cherry-pick"],
                            graph={"from": "release separate from bugfix branch", "to": "release gets a copied fix commit, not bugfix branch history"},
            ...
            level(
                ...
                uses_adventure_quests=["stash-local-work", "cherry-pick-one-commit", "inspect-status"],
                min_counted_commands=2,
                max_counted_commands=7,
                variants=[
                    variant(
                        ...
                        initial=repo(commits=PATCH_HISTORY[:3], branches={"release": "r1", "bugfix/login": "b1"}, head="release", working_tree={"notes.txt": {"status": "untracked", "content": "release draft\n"}}),
                        ...
                        evaluation=_contract(
                            ...
                            graph={"from": "release with dirty workspace and separate bugfix commit", "to": "release advances by copied fix; WIP kept outside DAG"},
    ...
    challenge(
        ...
        [
            level(
                ...
                uses_adventure_quests=["fetch-origin-updates", "inspect-remote-urls", "inspect-graph-history"],
                min_counted_commands=1,
                max_counted_commands=4,
                variants=[
                    variant(
                        ...
                        evaluation=_contract(
                            {
                                "branch_points_to": {"main": "c1"},
                                "remote_branch_points_to": {"origin/main": "r2"},
                                "rules": [{"type": "fetch_updated_remote_tracking_without_moving_local", "branch": "main"}],
                            },
                            required=["git fetch"],
                            graph={"from": "local main and origin/main both c1", "to": "origin/main advances to r2; main stays c1"},
            ...
            level(
                ...
                uses_adventure_quests=["pull-fast-forward-update", "fetch-origin-updates", "inspect-graph-history"],
                min_counted_commands=1,
                max_counted_commands=4,
                variants=[
                    variant(
                        ...
                        evaluation=_contract(
                            {
                                "branch_points_to": {"main": "r2"},
                                "remote_branch_points_to": {"origin/main": "r2"},
                                "rules": [{"type": "pull_moved_local_to_upstream", "branch": "main", "upstream": "origin/main"}],
                                "working_tree_clean": True,
                            },
                            required=["git pull"],
                            graph={"from": "main behind upstream", "to": "main fast-forwards to origin/main"},
            ...
            level(
                ...
                uses_adventure_quests=["fetch-origin-updates", "merge-with-merge-commit", "push-current-branch", "inspect-graph-history"],
                min_counted_commands=3,
                ...
                variants=[
                    variant(
                        ...
                        initial=repo(
                            ...
                            remotes={"origin": "https://example.test/team/app.git"},
                            remote_updates={"origin/main": "r2"},
                            remote_fixtures={"branches": {"origin/main": "r2"}, "default_branch": "origin/main", "commits": [REMOTE_DIVERGED[-1]]},
                        ),
                        solution=["git fetch origin", "git merge origin/main", "git push"],
                        evaluation=_contract(
                            {
                                "remote_branch_matches_local": {"origin/main": "main"},
                                "latest_commit": {"branch": "main", "contains_paths": ["review.md"], "message_contains": ["Merge"]},
                                "rules": [
                                    {"type": "commit_is_merge", "branch": "main"},
                            ...
                            graph={"from": "local and remote diverged after c1", "to": "published merge commit joins l2 and r2"},
                            concepts=["fetch before integrate", "merge remote-tracking ref", "publish merged result"],
                        ),
                    )
                ],
            ),
