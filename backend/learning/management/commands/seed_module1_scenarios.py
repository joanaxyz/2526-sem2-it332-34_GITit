...
def repo_with_head(
    *,
    ...
    state = {
        ...
        "commits": commits or [commit("c1", "Initial project snapshot", {"README.md": "readme-v1"})],
...
def clone_scenario() -> dict[str, Any]:
    easy_cases = [
        remote_case("clone-easy-docs-portal", "docs-portal", "https://example.test/training/docs-portal.git", "docs-portal", "r10", {"README.md": "docs-readme-v1", "docs/intro.md": "docs-intro-v1"}, [{"id": "r10", "message": "Create docs portal starter", "parents": [], "tree": {"README.md": "docs-readme-v1", "docs/intro.md": "docs-intro-v1"}}], "origin URL docs-portal; main/origin-main -> r10; docs tree checked out"),
        remote_case("clone-easy-api-lab", "api-lab", "https://example.test/training/api-lab.git", "api-lab", "r11", {"README.md": "api-readme-v1", "api/routes.py": "api-routes-v1"}, [{"id": "r11", "message": "Create API lab starter", "parents": [], "tree": {"README.md": "api-readme-v1", "api/routes.py": "api-routes-v1"}}], "origin URL api-lab; main/origin-main -> r11; API tree checked out"),
        remote_case("clone-easy-profile-site", "profile-site", "https://example.test/training/profile-site.git", "profile-site", "r12", {"index.html": "profile-index-v1", "styles/site.css": "profile-css-v1"}, [{"id": "r12", "message": "Create profile site starter", "parents": [], "tree": {"index.html": "profile-index-v1", "styles/site.css": "profile-css-v1"}}], "origin URL profile-site; main/origin-main -> r12; site tree checked out"),
    ]
    medium_cases = [
        remote_case("clone-medium-cli-tool", "cli-tool", "https://example.test/tools/cli-tool.git", "cli-practice", "r20", {"README.md": "cli-readme-v2", "src/parser.py": "cli-parser-v2"}, [{"id": "r19", "message": "Create CLI skeleton", "parents": [], "tree": {"README.md": "cli-readme-v1"}}, {"id": "r20", "message": "Add parser command", "parents": ["r19"], "tree": {"README.md": "cli-readme-v2", "src/parser.py": "cli-parser-v2"}}], "custom folder cli-practice; r20 tree/history"),
        remote_case("clone-medium-css-kit", "css-kit", "https://example.test/frontend/css-kit.git", "style-lab", "r21", {"README.md": "css-readme-v1", "styles/tokens.css": "tokens-v1"}, [{"id": "r21", "message": "Create style token kit", "parents": [], "tree": {"README.md": "css-readme-v1", "styles/tokens.css": "tokens-v1"}}], "custom folder style-lab; CSS token tree"),
        remote_case("clone-medium-recipe-book", "recipe-book", "https://example.test/docs/recipe-book.git", "kitchen-docs", "r22", {"README.md": "recipe-readme-v1", "recipes/adobo.md": "adobo-v1"}, [{"id": "r22", "message": "Create recipe book starter", "parents": [], "tree": {"README.md": "recipe-readme-v1", "recipes/adobo.md": "adobo-v1"}}], "custom folder kitchen-docs; recipe tree"),
    ]
    hard_cases = [
        remote_case("clone-hard-analytics", "analytics-lab", "git@example.test:training/analytics-lab.git", "analytics-worktree", "r30", {"README.md": "analytics-readme-v3", "metrics/report.md": "metrics-report-v2", "src/summary.py": "summary-v1"}, [{"id": "r28", "message": "Create analytics starter", "parents": [], "tree": {"README.md": "analytics-readme-v1"}}, {"id": "r29", "message": "Add metrics report", "parents": ["r28"], "tree": {"README.md": "analytics-readme-v2", "metrics/report.md": "metrics-report-v1"}}, {"id": "r30", "message": "Add summary script", "parents": ["r29"], "tree": {"README.md": "analytics-readme-v3", "metrics/report.md": "metrics-report-v2", "src/summary.py": "summary-v1"}}], "SSH URL; custom folder analytics-worktree; three-commit history ending r30"),
        remote_case("clone-hard-mobile-ui", "mobile-ui", "git@example.test:frontend/mobile-ui.git", "mobile-ui-lab", "r31", {"README.md": "mobile-readme-v2", "screens/home.tsx": "home-v1", "styles/mobile.css": "mobile-css-v1"}, [{"id": "r23", "message": "Create mobile UI shell", "parents": [], "tree": {"README.md": "mobile-readme-v1"}}, {"id": "r31", "message": "Add mobile home screen", "parents": ["r23"], "tree": {"README.md": "mobile-readme-v2", "screens/home.tsx": "home-v1", "styles/mobile.css": "mobile-css-v1"}}], "SSH URL; custom folder mobile-ui-lab; UI tree ending r31"),
    ...
    return scenario_dict(
        ...
        primary=["git clone"], supporting=["git remote -v", "git log --oneline", "git status"], concepts=["origin", "remote-tracking branch", "upstream", "working tree checkout"],
        difficulties={
            DIFFICULTY_EASY: diff((1, 1), "Clone with the default folder name.", "Use the provided remote URL and let the destination use the default repository name.", [clone_bp("clone-default-folder", easy_cases, False, "module1.clone.https-default-folder", "clone-https-default")]),
            DIFFICULTY_MEDIUM: diff((1, 1), "Clone into a required custom folder.", "Use the provided remote URL and the exact destination folder.", [clone_bp("clone-custom-folder", medium_cases, True, "module1.clone.https-custom-folder", "clone-https-custom-destination")]),
            DIFFICULTY_HARD: diff((1, 1), "Clone an SSH remote into a required custom folder with deeper history.", "Use the exact SSH-style remote and destination folder, then end with clean tracking refs.", [clone_bp("clone-ssh-custom-folder", hard_cases, True, "module1.clone.ssh-custom-folder-history", "clone-ssh-custom-history")]),
        },
    )


def remote_case(case_id: str, project: str, url: str, folder: str, head: str, tree: dict[str, Any], commits: list[dict[str, Any]], answer_anchor: str) -> dict[str, Any]:
    return {"case_id": case_id, "project": project, "remote_url": url, "destination_folder": folder, "remote_head": head, "remote_tree": tree, "remote_commits": commits, "answer_anchor": answer_anchor}


def clone_bp(slug: str, cases: list[dict[str, Any]], custom_folder: bool, signature: str, subtemplate: str) -> dict[str, Any]:
    command = "git clone {{remote_url}} {{destination_folder}}" if custom_folder else "git clone {{remote_url}}"
    return bp(
        slug=slug,
        kind="clone",
        signature=signature,
        subtemplate=subtemplate,
        cases=cases,
        initial_state=uninitialized_state(remote_fixtures={"branches": {"origin/main": "{{remote_head}}"}, "commits": "{{remote_commits}}"}),
        target_rule={
            "repository_initialized": True,
            "head_branch": "main",
...
def commit_scenario(base_tree: dict[str, str]) -> dict[str, Any]:
    cases_easy = [
        commit_case("commit-easy-form-validation", "form-flow", {"src/form.js": "form-validation-v2"}, ["src/form.js"], [], [], {"src/form.js": "form-validation-v2"}, "Update form validation", "commit message and changed path src/form.js"),
        commit_case("commit-easy-readme-setup", "setup-notes", {"README.md": "readme-setup-v2"}, ["README.md"], [], [], {"README.md": "readme-setup-v2"}, "Clarify setup steps", "commit message and changed path README.md"),
        commit_case("commit-easy-navbar-spacing", "style-polish", {"styles/navbar.css": "navbar-spacing-v2"}, ["styles/navbar.css"], [], [], {"styles/navbar.css": "navbar-spacing-v2"}, "Adjust navbar spacing", "commit message and changed path styles/navbar.css"),
    ]
    cases_medium = [
        commit_case("commit-medium-profile-card", "profile-card", {"src/profile-card.js": "profile-js-v2", "styles/profile-card.css": "profile-css-v2"}, ["src/profile-card.js", "styles/profile-card.css"], [], [], {"src/profile-card.js": "profile-js-v2", "styles/profile-card.css": "profile-css-v2"}, "Update profile card layout", "commit has two profile-card paths"),
        commit_case("commit-medium-search-results", "search-view", {"src/search.js": "search-js-v2", "templates/search.html": "search-template-v2"}, ["src/search.js", "templates/search.html"], [], [], {"src/search.js": "search-js-v2", "templates/search.html": "search-template-v2"}, "Refine search results view", "commit has JS and template paths"),
        commit_case("commit-medium-export-flow", "export-flow", {"src/export.py": "export-code-v2", "docs/export.md": "export-docs-v2"}, ["src/export.py", "docs/export.md"], [], [], {"src/export.py": "export-code-v2", "docs/export.md": "export-docs-v2"}, "Document export flow update", "commit has code and docs paths"),
    ]
    cases_hard = [
        commit_case("commit-hard-profile-distractor", "profile-card", {"src/profile-card.js": "profile-js-v3", "notes/profile-ideas.md": "profile-notes-draft"}, ["src/profile-card.js"], ["notes/profile-ideas.md"], ["notes/profile-ideas.md"], {"src/profile-card.js": "profile-js-v3"}, "Update profile card behavior", "commit includes profile-card.js; notes remain uncommitted"),
        commit_case("commit-hard-export-distractor", "export-flow", {"src/export.py": "export-code-v3", "scratch/export-test-output.txt": "export-output-draft"}, ["src/export.py"], ["scratch/export-test-output.txt"], ["scratch/export-test-output.txt"], {"src/export.py": "export-code-v3"}, "Fix export validation", "commit includes export.py; scratch output remains uncommitted"),
    ...
    return scenario_dict(
        ...
        primary=["git add", "git commit"], supporting=["git status", "git diff", "git diff --staged"], concepts=["working tree", "staging area", "commit", "branch tip"],
        difficulties={
            DIFFICULTY_EASY: diff((2, 3), "Commit one clear file change.", "Stage and save the single intended file with the required message.", [commit_bp("commit-single-file", cases_easy, base_tree, True, "module1.commit.single-file", "one-target-file")]),
            DIFFICULTY_MEDIUM: diff((2, 4), "Commit multiple related files.", "Stage and save all intended files as one focused snapshot.", [commit_bp("commit-multiple-files", cases_medium, base_tree, True, "module1.commit.multi-file", "multi-target-files")]),
            DIFFICULTY_HARD: diff((2, 5), "Commit intended work while leaving unrelated work out.", "Stage and save only the target files; leave unrelated work uncommitted.", [commit_bp("commit-selective-files", cases_hard, base_tree, False, "module1.commit.selective-with-distractor", "target-plus-distractor")]),
        },
    )


def commit_case(case_id: str, project: str, working_tree: dict[str, Any], target_files: list[str], excluded_files: list[str], allowed_working_tree_paths: list[str], target_tree_requirements: dict[str, Any], message: str, answer_anchor: str) -> dict[str, Any]:
    return {
        "case_id": case_id,
        "project": project,
        "base_commit": "c1",
...
def commit_bp(slug: str, cases: list[dict[str, Any]], base_tree: dict[str, str], clean: bool, signature: str, subtemplate: str) -> dict[str, Any]:
    rules = [
    ...
    target_rule = {
        "head_branch": "main",
        "latest_commit": {"branch": "main", "message_contains": ["{{required_commit_message}}"], "contains_paths": "{{target_files}}", "excludes_paths": "{{excluded_files}}"},
        "staging_empty": True,
        "rules": rules,
    }
    if clean:
    ...
    return bp(
        ...
        subtemplate=subtemplate,
        cases=cases,
        initial_state=repo_with_head(commits=[commit("c1", "Initial project snapshot", base_tree)], working_tree="{{working_tree}}"),
...
def gitignore_scenario() -> dict[str, Any]:
    ...
    easy_cases = [
        ignore_case("ignore-easy-node-env", "node-app", "node-ignore-v1", ["node_modules/pkg/index.js", ".env"], "Add Node ignore rules", "commit contains .gitignore token node-ignore-v1; excludes node_modules and .env"),
        ignore_case("ignore-easy-python-cache", "python-api", "python-ignore-v1", ["__pycache__/app.cpython.pyc", ".env"], "Add Python ignore rules", "commit contains .gitignore token python-ignore-v1; excludes pycache and .env"),
        ignore_case("ignore-easy-web-build", "static-site", "web-ignore-v1", ["dist/site.js", "dist/site.css"], "Add web build ignore rules", "commit contains .gitignore token web-ignore-v1; excludes dist outputs"),
    ]
    medium_cases = [
        ignore_case("ignore-medium-node-logs-build", "node-dashboard", "node-ignore-v2", ["node_modules/lib.js", "dist/app.js", "logs/debug.log", ".env.local"], "Ignore Node dependencies and build output", "excludes four ignored artifact paths"),
        ignore_case("ignore-medium-python-venv-cache", "data-tools", "python-ignore-v2", [".venv/pyvenv.cfg", "__pycache__/clean.cpython.pyc", "output/report.csv"], "Ignore Python environment artifacts", "excludes venv, cache, and output paths"),
        ignore_case("ignore-medium-java-target", "java-service", "java-ignore-v1", ["target/classes/App.class", "target/app.jar", "logs/server.log"], "Ignore Java build artifacts", "excludes target and log paths"),
    ]
    hard_cases = [
        ignore_case("ignore-hard-untrack-env", "backend-service", "service-ignore-v3", [".env", "logs/server.log"], "Stop tracking local environment files", ".env removed from committed tree but remains local/ignored; .gitignore committed", tracked_generated_path=".env", base_tree={**base, ".env": "secret-v1"}),
        ignore_case("ignore-hard-untrack-dist", "frontend-bundle", "frontend-ignore-v3", ["dist/app.js", "dist/app.css"], "Stop tracking build outputs", "dist/app.js removed from commit tree; build outputs remain local/ignored", tracked_generated_path="dist/app.js", base_tree={**base, "dist/app.js": "dist-old"}),
    ...
    return scenario_dict(
        ...
        difficulties={
            DIFFICULTY_EASY: diff((2, 4), "Commit simple ignore rules.", "Commit .gitignore while ignored generated files remain local.", [ignore_bp("ignore-basic", easy_cases, base, False, "module1.ignore.basic", "ignore-untracked-generated")], completion_type=COMPLETION_EXPANDED_STATE_BASED),
            DIFFICULTY_MEDIUM: diff((2, 5), "Commit ecosystem-specific ignore rules.", "Commit .gitignore with several patterns and keep all generated paths out.", [ignore_bp("ignore-ecosystem", medium_cases, base, False, "module1.ignore.ecosystem", "multiple-ignore-patterns")], completion_type=COMPLETION_EXPANDED_STATE_BASED),
            DIFFICULTY_HARD: diff((3, 6), "Stop tracking a generated file and keep it local.", "Commit ignore rules and remove one already tracked generated path from tracking.", [ignore_bp("ignore-tracked-generated", hard_cases, "{{base_tree}}", True, "module1.ignore.tracked-generated", "tracked-generated-removal")], completion_type=COMPLETION_EXPANDED_STATE_BASED),
        },
    )


def ignore_case(case_id: str, project: str, token: str, ignored_paths: list[str], message: str, answer_anchor: str, *, tracked_generated_path: str = "none", base_tree: dict[str, Any] | None = None) -> dict[str, Any]:
...
def ignore_bp(slug: str, cases: list[dict[str, Any]], base_tree: dict[str, str] | str, hard: bool, signature: str, subtemplate: str) -> dict[str, Any]:
    latest_excludes: list[str] | str = "{{excluded_files}}"
    if hard:
        latest_excludes = []
    rules = [
        {"type": "ignored_paths_present", "paths": "{{ignored_paths}}"},
        {"type": "commit_tree_contains", "branch": "main", "tree": {".gitignore": "{{gitignore_token}}"}},
    ...
    if hard:
        solution = ["git rm --cached {{tracked_generated_path}}", "git add .gitignore", "git commit -m \"{{required_commit_message}}\""]
        rules.append({"type": "tracked_path_removed_from_commit_tree", "paths": ["{{tracked_generated_path}}"]})
        rules.append({"type": "operation_metadata_contains", "key": "last_rm_cached_paths", "value": "{{tracked_generated_path}}"})
    else:
        rules.append({"type": "ignored_paths_excluded_from_commit", "paths": "{{ignored_paths}}"})
    return bp(
        slug=slug, kind="gitignore", signature=signature, subtemplate=subtemplate, cases=cases,
        initial_state=repo_with_head(commits=[commit("c1", "Initial project snapshot", base_tree)], working_tree="{{working_tree}}"),
        target_rule={"head_branch": "main", "latest_commit": {"branch": "main", "message_contains": ["{{required_commit_message}}"], "contains_paths": "{{target_files}}", "excludes_paths": latest_excludes}, "staging_empty": True, "working_tree_clean": True, "rules": rules},
        solution=solution, label="Ignore rules for {{project}}", slug_template="ignore-{{case_id}}",
    )


def partial_staging_scenario() -> dict[str, Any]:
    cases_easy = [
        partial_case("partial-easy-auth-validation", "auth-module", ["src/auth.py"], ["auth-validation-hunk"], ["auth-refactor-hunk"], [], "Isolate auth validation", "commit contains auth-validation-hunk; working tree keeps auth-refactor-hunk"),
        partial_case("partial-easy-search-ranking", "search-module", ["src/search.py"], ["search-ranking-hunk"], ["search-cleanup-hunk"], [], "Isolate search ranking", "commit contains search-ranking-hunk; working tree keeps search-cleanup-hunk"),
        partial_case("partial-easy-export-format", "export-module", ["src/export.py"], ["export-format-hunk"], ["export-logging-hunk"], [], "Isolate export formatting", "commit contains export-format-hunk; working tree keeps export-logging-hunk"),
    ]
    cases_medium = [
        partial_case("partial-medium-profile-validation", "profile-editor", ["src/profile.py"], ["profile-validation-hunk"], ["profile-copy-hunk", "profile-cleanup-hunk"], ["notes/profile-todo.md"], "Commit profile validation only", "validation hunk committed; two hunks and notes remain uncommitted"),
        partial_case("partial-medium-payment-rounding", "payment-flow", ["src/payment.py"], ["payment-rounding-hunk"], ["payment-logging-hunk", "payment-comment-hunk"], ["tmp/payment-scratch.txt"], "Commit payment rounding fix", "rounding hunk committed; logging/comment hunks remain"),
        partial_case("partial-medium-dashboard-filter", "dashboard", ["src/dashboard.js"], ["dashboard-filter-hunk"], ["dashboard-theme-hunk", "dashboard-console-hunk"], ["notes/dashboard-ideas.md"], "Commit dashboard filter change", "filter hunk committed; theme/console hunks remain"),
    ]
    cases_hard = [
        partial_case("partial-hard-auth-cross-file", "auth-module", ["src/auth.py", "tests/test_auth.py"], ["auth-validation-hunk", "auth-validation-test-hunk"], ["auth-refactor-hunk", "auth-test-cleanup-hunk"], ["notes/auth-debug.md"], "Commit auth validation path", "two validation hunks committed across files; refactor/test cleanup and notes remain"),
        partial_case("partial-hard-search-cross-file", "search-module", ["src/search.py", "tests/test_search.py"], ["search-ranking-hunk", "search-ranking-test-hunk"], ["search-cleanup-hunk", "search-test-fixture-hunk"], ["tmp/search-output.txt"], "Commit search ranking path", "ranking hunks committed across code/test; cleanup/fixture and tmp remain"),
    ...
    return scenario_dict(
        ...
        difficulties={
            DIFFICULTY_EASY: diff((2, 4), "Commit one selected hunk from one file.", "Commit only the named hunk and leave the other hunk in the working tree.", [partial_bp("partial-one-file", cases_easy, "module1.partial.one-file", "two-hunks-one-file")], completion_type=COMPLETION_EXPANDED_STATE_BASED),
            DIFFICULTY_MEDIUM: diff((2, 5), "Commit one hunk while another file remains unrelated.", "Commit only the target hunk and leave the unrelated file out.", [partial_bp("partial-with-unrelated", cases_medium, "module1.partial.with-unrelated", "hunk-plus-unrelated-file")], completion_type=COMPLETION_EXPANDED_STATE_BASED),
            DIFFICULTY_HARD: diff((2, 6), "Commit selected hunks across files in a noisy workspace.", "Use the hunk-level target and leave all unrelated work out of the final snapshot.", [partial_bp("partial-noisy", cases_hard, "module1.partial.noisy", "cross-file-hunk-selection")], completion_type=COMPLETION_EXPANDED_STATE_BASED),
        },
    )


def partial_case(case_id: str, project: str, target_files: list[str], target_hunks: list[str], leftover_hunks: list[str], unrelated_files: list[str], message: str, answer_anchor: str) -> dict[str, Any]:
    ...
    return {
        ...
        "required_commit_message": message,
        "solution_commands": [*(f"git add -p {path}" for path in target_files), f"git commit -m \"{message}\""],
        "answer_anchor": answer_anchor,
...
def partial_bp(slug: str, cases: list[dict[str, Any]], signature: str, subtemplate: str) -> dict[str, Any]:
    return bp(
        slug=slug, kind="partial", signature=signature, subtemplate=subtemplate, cases=cases,
        initial_state=repo_with_head(commits=[commit("c1", "Initial project snapshot", {"README.md": "readme-v1"})], working_tree="{{working_tree}}", partial_hunks="{{partial_hunks}}"),
        target_rule={
            "head_branch": "main",
            "latest_commit": {"branch": "main", "message_contains": ["{{required_commit_message}}"], "contains_paths": "{{target_files}}", "excludes_paths": "{{excluded_files}}"},
        ...
        label="Partial stage {{project}}", slug_template="partial-{{case_id}}",
    )


def amend_scenario() -> dict[str, Any]:
    easy = [
        amend_case("amend-easy-login-copy-message", "login-copy", ["src/login.js"], "Update text", "Clarify login copy", {}, "branch tip is amended commit with message Clarify login copy; no extra commit"),
        amend_case("amend-easy-readme-message", "setup-docs", ["README.md"], "Update README", "Clarify setup requirements", {}, "amended tip message Clarify setup requirements; same tree"),
        amend_case("amend-easy-navbar-message", "style-polish", ["styles/navbar.css"], "CSS updates", "Adjust navbar spacing", {}, "amended tip message Adjust navbar spacing; same tree"),
    ]
    medium = [
        amend_case("amend-medium-profile-missing-css", "profile-card", ["src/profile-card.js", "styles/profile-card.css"], "Update profile card layout", "Update profile card layout", {"styles/profile-card.css": "profile-css-v2"}, "amended tip includes missing CSS without creating new commit"),
        amend_case("amend-medium-export-doc", "export-flow", ["src/export.py", "docs/export.md"], "Document export flow update", "Document export flow update", {"docs/export.md": "export-docs-v2"}, "amended tip includes export docs"),
        amend_case("amend-medium-search-template", "search-view", ["src/search.js", "templates/search.html"], "Refine search results view", "Refine search results view", {"templates/search.html": "search-template-v2"}, "amended tip includes search template"),
    ]
    hard = [
        amend_case("amend-hard-profile-message-and-css", "profile-card", ["src/profile-card.js", "styles/profile-card.css"], "Update profile stuff", "Update profile card layout", {"styles/profile-card.css": "profile-css-v3"}, "amended tip has corrected message and missing CSS; old tip replaced"),
        amend_case("amend-hard-auth-message-and-test", "auth-module", ["src/auth.py", "tests/test_auth.py"], "Auth changes", "Add auth validation coverage", {"tests/test_auth.py": "auth-test-v2"}, "amended tip has corrected message and test path; no extra child commit"),
    ...
    return scenario_dict(
        ...
        difficulties={
            DIFFICULTY_EASY: diff((1, 2), "Fix only the latest commit message.", "Repair the latest commit message without creating a separate commit.", [amend_bp("amend-message-only", easy, "module1.amend.message-only", "message-only")], completion_type=COMPLETION_EXPANDED_STATE_BASED),
            DIFFICULTY_MEDIUM: diff((2, 4), "Add missing content to the latest commit.", "Stage the missing file and repair the latest commit while keeping its message.", [amend_bp("amend-content-only", medium, "module1.amend.content", "content-only")], completion_type=COMPLETION_EXPANDED_STATE_BASED),
            DIFFICULTY_HARD: diff((2, 5), "Fix latest commit message and content together.", "Repair both the message and missing content in the latest commit.", [amend_bp("amend-message-and-content", hard, "module1.amend.message-content", "message-and-content")], completion_type=COMPLETION_EXPANDED_STATE_BASED),
        },
    )


def amend_case(case_id: str, project: str, target_files: list[str], old_message: str, new_message: str, working_tree: dict[str, Any], answer_anchor: str) -> dict[str, Any]:
    ...
    return {
        ...
        "working_tree": working_tree,
        "commits": [commit("c1", "Initial project snapshot", tree_c1), commit("c2", old_message, tree_c2, ["c1"])],
        "solution_commands": [*(f"git add {path}" for path in working_tree), f"git commit --amend -m \"{new_message}\""],
        "answer_anchor": answer_anchor,
    }


def amend_bp(slug: str, cases: list[dict[str, Any]], signature: str, subtemplate: str) -> dict[str, Any]:
    return bp(
        slug=slug, kind="amend", signature=signature, subtemplate=subtemplate, cases=cases,
        initial_state=repo_with_head(commits="{{commits}}", head="c2", working_tree="{{working_tree}}"),
        target_rule={"head_branch": "main", "latest_commit": {"branch": "main", "message_contains": ["{{required_commit_message}}"], "contains_paths": "{{target_files}}"}, "staging_empty": True, "working_tree_clean": True, "rules": [{"type": "operation_metadata_equals", "key": "last_amend_replaced_commit", "value": "{{commit_to_repair}}"}, {"type": "branch_tip_replaces_commit", "old": "{{commit_to_repair}}"}, {"type": "commit_replaced_by_amend", "old": "{{commit_to_repair}}"}]},
        solution="{{solution_commands}}", label="Amend {{project}}", slug_template="amend-{{case_id}}",
    )


def restore_scenario() -> dict[str, Any]:
    easy = [
        restore_case("restore-easy-unstage-app", "cleanup-lab", {"src/app.py": "app-change-v2"}, {}, ["src/app.py"], [], "src/app.py moves from staging to working_tree; no commit created"),
        restore_case("restore-easy-unstage-guide", "docs-lab", {"docs/guide.md": "guide-change-v2"}, {}, ["docs/guide.md"], [], "docs/guide.md unstaged and preserved"),
        restore_case("restore-easy-unstage-css", "style-lab", {"styles/site.css": "css-change-v2"}, {}, ["styles/site.css"], [], "styles/site.css unstaged and preserved"),
    ]
    medium = [
        restore_case("restore-medium-app-debug", "cleanup-lab", {"src/app.py": "app-change-v2"}, {"debug.log": "debug-draft"}, ["src/app.py"], ["debug.log"], "app.py preserved as working change; debug.log discarded"),
        restore_case("restore-medium-docs-scratch", "docs-lab", {"docs/guide.md": "guide-change-v2"}, {"tmp/scratch.txt": "scratch-draft"}, ["docs/guide.md"], ["tmp/scratch.txt"], "guide preserved; scratch discarded"),
        restore_case("restore-medium-css-build", "style-lab", {"styles/site.css": "css-change-v2"}, {"dist/site.css": "dist-generated"}, ["styles/site.css"], ["dist/site.css"], "source CSS preserved; generated dist discarded"),
    ]
    hard = [
        restore_case("restore-hard-mixed-profile", "profile-card", {"src/profile-card.js": "profile-js-v2", "notes/profile-ideas.md": "notes-draft"}, {"debug/profile.log": "debug-draft"}, ["src/profile-card.js"], ["debug/profile.log"], "all staging cleared; profile-card.js preserved; debug log discarded; no commit"),
        restore_case("restore-hard-mixed-export", "export-flow", {"src/export.py": "export-code-v2", "notes/export-plan.md": "notes-draft"}, {"tmp/export-output.txt": "generated-output"}, ["src/export.py"], ["tmp/export-output.txt"], "export.py preserved; notes unstaged; generated output discarded; no commit"),
    ...
    return scenario_dict(
        ...
        difficulties={
            DIFFICULTY_EASY: diff((1, 2), "Unstage one file while keeping its working-tree change.", "Move the staged file back to the working tree without discarding it.", [restore_bp("restore-unstage-one", easy, "module1.restore.unstage-one", "one-file-unstage")]),
            DIFFICULTY_MEDIUM: diff((2, 4), "Unstage one file and discard another working-tree change.", "Keep the staged work as a working-tree change and remove the unwanted file.", [restore_bp("restore-unstage-and-discard", medium, "module1.restore.unstage-discard", "one-keep-one-discard")]),
            DIFFICULTY_HARD: diff((2, 5), "Clean a noisy mixed state.", "Preserve the requested path and discard the unwanted path without making a commit.", [restore_bp("restore-noisy", hard, "module1.restore.noisy", "multiple-staged-one-discard")]),
        },
    )


def restore_case(case_id: str, project: str, initial_staging: dict[str, Any], initial_working_tree: dict[str, Any], keep_paths: list[str], discard_paths: list[str], answer_anchor: str) -> dict[str, Any]:
...
def restore_bp(slug: str, cases: list[dict[str, Any]], signature: str, subtemplate: str) -> dict[str, Any]:
    return bp(
        slug=slug, kind="restore", signature=signature, subtemplate=subtemplate, cases=cases,
        initial_state=repo_with_head(commits=[commit("c1", "Initial project snapshot", {"README.md": "readme-v1", "src/app.py": "app-v1", "styles/site.css": "style-v1"})], staging="{{staging}}", working_tree="{{working_tree}}"),
        target_rule={"head_branch": "main", "branch_points_to": {"main": "c1"}, "staging_empty": True, "working_tree_contains": "{{keep_paths}}", "working_tree_absent": "{{discard_paths}}", "rules": [{"type": "commit_count_equals", "count": 1}]},
        solution="{{solution_commands}}",
        label="Restore {{project}}", slug_template="restore-{{case_id}}",
    )
...
def review_scenario() -> dict[str, Any]:
    clean_cases = [
        ...
        review_clean_case("review-easy-profile-ignore", "profile-site", ["src/profile-card.js", ".gitignore"], ["dist/profile-card.js"], "Prepare profile card update", "commit contains profile-card.js + .gitignore; excludes dist artifact"),
        review_clean_case("review-easy-export-ignore", "export-flow", ["src/export.py", ".gitignore"], ["output/export.csv"], "Prepare export workflow update", "commit contains export.py + .gitignore; excludes output CSV"),
    ]
    medium_cases = [
        review_clean_case("review-medium-profile-with-note", "profile-card", ["src/profile-card.js", "styles/profile-card.css", ".gitignore"], ["notes/profile-ideas.md", "dist/profile-card.js"], "Finalize profile card update", "commit has two source files + .gitignore; note remains; dist ignored", allowed_working_tree_paths=["notes/profile-ideas.md"]),
        review_clean_case("review-medium-search-with-output", "search-view", ["src/search.js", "templates/search.html", ".gitignore"], ["notes/search-ranking.md", "output/search-results.json"], "Finalize search results update", "source/template committed; note remains; output ignored", allowed_working_tree_paths=["notes/search-ranking.md"]),
        review_clean_case("review-medium-export-with-note", "export-flow", ["src/export.py", "docs/export.md", ".gitignore"], ["notes/export-plan.md", "output/export.csv"], "Finalize export documentation update", "code/docs/.gitignore committed; note remains; output ignored", allowed_working_tree_paths=["notes/export-plan.md"]),
    ]
    hard_partial_cases = [
        partial_case("review-hard-auth-partial", "auth-module", ["src/auth.py", "tests/test_auth.py"], ["auth-validation-hunk", "auth-validation-test-hunk"], ["auth-refactor-hunk", "auth-test-cleanup-hunk"], ["notes/auth-debug.md"], "Finalize auth validation change", "only validation hunks committed; leftovers and notes remain"),
        partial_case("review-hard-search-partial", "search-view", ["src/search.js", "tests/test_search.js"], ["search-ranking-hunk", "search-ranking-test-hunk"], ["search-theme-hunk", "search-fixture-cleanup-hunk"], ["tmp/search-output.json"], "Finalize search ranking behavior", "ranking hunks committed; theme/fixture/tmp leftovers remain"),
    ]
    hard_amend_cases = [
        amend_case("review-hard-export-amend", "export-flow", ["src/export.py", "docs/export.md"], "Export update", "Finalize export validation behavior", {"docs/export.md": "export-docs-final"}, "branch tip is amended commit with corrected message and docs; no extra commit"),
    ]
    return scenario_dict(
        lesson=(9, "module-1-review-and-practice", "Module 1 Review and Practice", "Combine the local workflow skills in larger repository situations."),
        slug="module1-integrated-local-workflow", title="Complete a focused local workflow", focus="local repository workflow",
        summary="Combine Module 1 skills to reach a clean local repository outcome.", explanation="The review scenario combines inspection, staging, committing, ignore rules, partial staging, restore, or amend within one local workflow task.",
        primary=["git add", "git commit"], supporting=["git status", "git diff", "git diff --staged", "git log --oneline"], concepts=["focused snapshot", "ignore rules", "partial staging", "amend", "clean final state"], kind=ScenarioSkillFocus.SkillFocusType.WORKFLOW_SPECIFIC,
        difficulties={
            DIFFICULTY_EASY: diff((3, 6), "Clean focused commit with one target file and one ignored artifact.", "Commit the required file and ignore rules while leaving generated output out.", [review_clean_bp("review-clean-ignore", clean_cases, "module1.review.clean-ignore", "clean-commit-with-ignore")], completion_type=COMPLETION_EXPANDED_STATE_BASED),
            DIFFICULTY_MEDIUM: diff((3, 7), "Focused commit with .gitignore plus excluded local note or output.", "Commit the focused source changes and ignore rules while preserving the excluded local note.", [review_clean_bp("review-focused-leftover", medium_cases, "module1.review.focused-leftover", "focused-commit-with-leftover")], completion_type=COMPLETION_EXPANDED_STATE_BASED),
            DIFFICULTY_HARD: diff((3, 8), "Focused snapshot using partial staging or amend repair.", "Use the appropriate Module 1 workflow to produce the exact focused final state.", [review_partial_bp("review-partial", hard_partial_cases), review_amend_bp("review-amend", hard_amend_cases)], completion_type=COMPLETION_EXPANDED_STATE_BASED),
        },
    )


def review_clean_case(case_id: str, project: str, target_files: list[str], excluded_files: list[str], message: str, answer_anchor: str, *, allowed_working_tree_paths: list[str] | None = None) -> dict[str, Any]:
    working_tree: dict[str, Any] = {path: f"{path}-v2" for path in target_files if path != ".gitignore"}
    ...
    for path in excluded_files:
        working_tree[path] = "local-draft" if path in visible_leftovers else {"status": "ignored", "content": f"{path}-generated"}
    return {
        "case_id": case_id,
        "project": project,
        "target_files": target_files,
...
def review_clean_bp(slug: str, cases: list[dict[str, Any]], signature: str, subtemplate: str) -> dict[str, Any]:
    return bp(slug=slug, kind="review", signature=signature, subtemplate=subtemplate, cases=cases, initial_state=repo_with_head(working_tree="{{working_tree}}"), target_rule={"head_branch": "main", "latest_commit": {"branch": "main", "message_contains": ["{{required_commit_message}}"], "contains_paths": "{{target_files}}", "excludes_paths": "{{excluded_files}}"}, "staging_empty": True, "rules": [{"type": "working_tree_clean_except", "paths": "{{allowed_working_tree_paths}}"}, {"type": "ignored_paths_present", "paths": "{{ignored_paths}}"}]}, solution=["git add {{stage_args}}", "git commit -m \"{{required_commit_message}}\""], label="Review {{project}}", slug_template="review-{{case_id}}")


def review_partial_bp(slug: str, cases: list[dict[str, Any]]) -> dict[str, Any]:
    return bp(slug=slug, kind="review", signature="module1.review.partial", subtemplate="partial-staging-review", cases=cases, initial_state=repo_with_head(commits=[commit("c1", "Initial project snapshot", {"README.md": "readme-v1"})], working_tree="{{working_tree}}", partial_hunks="{{partial_hunks}}"), target_rule={"head_branch": "main", "latest_commit": {"branch": "main", "message_contains": ["{{required_commit_message}}"], "contains_paths": "{{target_files}}", "excludes_paths": "{{excluded_files}}"}, "working_tree_contains": "{{target_files}}", "staging_empty": True, "rules": [{"type": "partial_hunks_committed", "paths": "{{target_hunk_map}}"}, {"type": "partial_hunks_left_in_working_tree", "paths": "{{leftover_hunk_map}}"}, {"type": "commit_changes_exclude_tokens", "tokens": "{{leftover_hunks}}"}, {"type": "working_tree_clean_except", "paths": "{{allowed_working_tree_paths}}"}]}, solution="{{solution_commands}}", label="Review {{project}}", slug_template="review-{{case_id}}")


def review_amend_bp(slug: str, cases: list[dict[str, Any]]) -> dict[str, Any]:
    return bp(slug=slug, kind="review", signature="module1.review.amend", subtemplate="amend-review", cases=cases, initial_state=repo_with_head(commits="{{commits}}", head="c2", working_tree="{{working_tree}}"), target_rule={"head_branch": "main", "latest_commit": {"branch": "main", "message_contains": ["{{required_commit_message}}"], "contains_paths": "{{target_files}}"}, "staging_empty": True, "working_tree_clean": True, "rules": [{"type": "operation_metadata_equals", "key": "last_amend_replaced_commit", "value": "{{commit_to_repair}}"}, {"type": "branch_tip_replaces_commit", "old": "{{commit_to_repair}}"}]}, solution="{{solution_commands}}", label="Review {{project}}", slug_template="review-{{case_id}}")


def scenario_dict(*, lesson, slug, title, focus, summary, explanation, primary, supporting, concepts, difficulties, kind=ScenarioSkillFocus.SkillFocusType.COMMAND_SPECIFIC):
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--reset", action="store_true", help="Delete existing Module 1 content and generated sessions before seeding.")
        parser.add_argument("--confirm", action="store_true", help="Required with --reset to confirm development data deletion.")
        parser.add_argument("--validate-build", action="store_true", help="Try generating one variant for every difficulty after seeding.")
        ...
        for spec in specs:
            ...
            for difficulty, dspec in spec["difficulties"].items():
                ...
                TargetStateRule.objects.update_or_create(
                    difficulty_instance=difficulty_instance,
                    defaults={"rule": dspec["blueprints"][0]["target_rule_template"], "target_state_hash": ""},
                )
                ...
                for index, blueprint in enumerate(dspec["blueprints"], start=1):
                    ...
                    ScenarioGenerationBlueprint.objects.update_or_create(
                        ...
                        defaults={
                            ...
                            "expected_observations_template": blueprint["expected_observations_template"],
                ...
                ScenarioGenerationBlueprint.objects.filter(difficulty_instance=difficulty_instance).exclude(slug__in=existing_slugs).delete()
    ...
    def _reset_module_one(self, *, confirm: bool):
        ...
        ScenarioGenerationBlueprint.objects.filter(difficulty_instance__scenario__learning_unit=unit).delete()
...
""".strip()
    ...
    def _validate_builds(self):
        ...
        created_variant_ids = []
        try:
            for difficulty in DifficultyInstance.objects.filter(scenario__learning_unit__slug="local-repository-foundations").order_by("scenario__sort_order", "difficulty"):
                fingerprints = set()
                anchors = set()
                candidates = []
                for blueprint in difficulty.generation_blueprints.filter(is_published=True).order_by("sort_order", "id"):
                    candidates.extend(builder._candidates([blueprint]))
                if not candidates:
                    failures.append(f"{difficulty.scenario.slug}/{difficulty.difficulty}: no blueprint cases")
                    continue
                for index, candidate in enumerate(candidates, start=1):
                    try:
                        ...
                        self.stdout.write(f"Built {difficulty.scenario.slug}/{difficulty.difficulty}: {variant.slug}")
                    except ScenarioVariantBuildError as exc:
                        failures.append(f"{difficulty.scenario.slug}/{difficulty.difficulty}: {exc}")
                if len(candidates) > 1 and len(fingerprints) != len(candidates):
                    failures.append(f"{difficulty.scenario.slug}/{difficulty.difficulty}: duplicate parameter fingerprints")
                if len(candidates) > 1 and len(anchors) != len(candidates):
                    failures.append(f"{difficulty.scenario.slug}/{difficulty.difficulty}: duplicate or missing answer anchors")
        finally:
            ScenarioVariant.objects.filter(id__in=created_variant_ids).delete()
        if failures:
            raise CommandError("Variant validation failed:\n" + "\n".join(failures))
        self.stdout.write(self.style.SUCCESS("All Module 1 blueprint cases generated valid variants. Validation variants were removed."))
