...
def _kit_piece(slug="official-crown", piece_type="crown"):
...
def test_registration_grants_the_kit(django_user_model):
    ...
    assert Entitlement.objects.filter(user=user, asset__slug="official-crown").exists()
...
def test_granted_official_piece_stays_labelled_official(django_user_model):
    ...
    assert descriptors["official-crown"]["source"] == "official"
