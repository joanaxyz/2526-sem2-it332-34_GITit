...
class StoreListingAdmin(admin.ModelAdmin):
    ...
    search_fields = ("asset__slug", "content_definition__title", "tower_design__title")
...
class EntitlementAdmin(admin.ModelAdmin):
    ...
    search_fields = ("user__username", "asset__slug", "content_definition__title", "tower_design__title")
