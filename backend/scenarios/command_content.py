        ...
        _section(
            ...
            content=[
                _paragraph(
                    ...
                    "a compact one-line view, and a graph view across all refs."
                ),
                _callout(
                    "Read-only command",
...
GIT_COMMAND_CONTENT_LIBRARY: list[dict[str, Any]] = [
    _content(
        ...
        aliases=["git st", "git status -s", "git status --short", "git status --porcelain"],
        summary=(
        ...
        syntax=["git status", "git status -s", "git status --short", "git status --porcelain"],
    ...
    _content(
        ...
        aliases=["git log --oneline", "git log --oneline --graph --all"],
        summary=(
        ...
        syntax=["git log", "git log --oneline", "git log --oneline --graph --all"],
    ...
    _content(
        ...
        aliases=["git diff -- <path>", "git diff --staged", "git diff --cached"],
        summary="git diff shows unstaged working-tree changes compared with the index.",
        tags=["diagnostic", "working-tree", "diff"],
        syntax=["git diff", "git diff -- <path>", "git diff --staged", "git diff --cached"],
    ...
    _content(
        ...
        aliases=["git branch -v", "git branch <name>", "git branch -d <name>"],
        summary="git branch lists local branches; -v also shows the commit each branch points to.",
        tags=["diagnostic", "branches"],
        syntax=["git branch", "git branch -v", "git branch <name>", "git branch -d <name>", "git branch -D <name>"],
        effects=["Reports local branch names and tips when used as a listing command."],
        boundaries=["Listing branches does not switch branches. Creating and deleting branches are counted actions in the simulator."],
        ...
        options=[
            ...
            },
            {
                "token": "-d / -D",
                "title": "Delete branch",
                "body": "Deletes a named branch in simulator state; -D is accepted as the force-delete form.",
            },
        ],
        arguments=[
            {
                "token": "<name>",
                "title": "Branch name",
                "body": "Names the branch to create or delete. Listing forms do not take a name.",
            },
        ],
    ),
    _content(
        ...
        aliases=["git remote", "git remote add <name> <url>", "git remote remove <name>", "git remote rename <old> <new>"],
        ...
        effects=["Reports configured remote relationships when used without an action; add, remove, and rename mutate simulator remotes."],
        ...
        arguments=[
            {
                "token": "<name>",
                "title": "Remote name",
                "body": "Names the remote for add, remove, or rename actions.",
            },
            {
                "token": "<url>",
                "title": "Remote URL",
                "body": "Provides the URL stored by git remote add.",
            },
        ],
    ),
    _content(
    ...
    _content(
        ...
        aliases=["git init <directory>", "git init -q"],
        summary=(
        ...
        effects=["Creates simulator Git metadata at the current or named directory and resets branch/remote metadata for that repository."],
    ...
    _content(
        ...
        aliases=["git add .", "git add -A", "git add --all", "git add -u", "git add --intent-to-add <path>"],
        ...
        options=[
            ...
            },
            {
                "token": "--intent-to-add",
                "title": "Intent to add",
                "body": "Marks a path in the index without staging file content yet.",
            },
            {
                "token": "-p / --patch",
                "title": "Patch staging",
    ...
    _content(
        ...
        syntax=["git add -p <path>", "git add --patch <path>"],
    ...
    _content(
        ...
        syntax=["git rm <path>", "git rm --cached <path>"],
    ...
    _content(
        ...
        aliases=["git commit", "git commit -a -m \"message\"", "git commit --allow-empty -m \"message\""],
        summary="git commit saves the staged snapshot and advances the current branch tip.",
        tags=["action", "history", "snapshot"],
        syntax=['git commit -m "message"', 'git commit -a -m "message"', 'git commit --allow-empty -m "message"', 'git commit --amend -m "message"'],
        ...
        options=[
            ...
            },
            {
                ...
                "body": "Allows a commit even when the index has no staged changes.",
            },
            {
                "token": "--amend",
