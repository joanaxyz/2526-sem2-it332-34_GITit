...
import { storeysApi } from '@/features/modules/api/modulesApi'
import { StoreyPracticeHub } from '@/features/modules/components/ModulePracticeHub'
...
export function TowerPage() {
  ...
  const storeyParam = searchParams.get('storey') ?? searchParams.get('module')
  ...
  const storeys = storeysQuery.data ?? []
