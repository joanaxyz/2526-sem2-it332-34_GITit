...
/**
 * Medieval ranked ladder derived deterministically from dashboard data.
 *
...
export function rankScore(summary: DashboardSummary): number {
  return summary.counts.completed * 2 + summary.first_attempt_stars
}

export function deriveRank(summary: DashboardSummary): RankInfo {
