...
import { BLOCK_TYPES, emptyPage, type BookBlock, type BookPage } from '@/features/authoring/utils/authoringModel'

/** Structured page/block editor for a lesson (replaces raw JSON). */
export function ChapterLessonPagesEditor({
  pages,
  onChange,
}: {
  pages: BookPage[]
  ...
  return (
    <section className="author-card">
      <header className="author-card-head">
        ...
        <p className="author-card-sub">A lesson is pure reading — no runs or battles.</p>
      </header>
