...
const tourSteps = [
  {
    ...
    icon: PanelLeft,
    label: 'Story',
    body: 'The scenario, task, copy details, and attempt state live here. Read this before touching the terminal.',
    placement: 'right',
  },
  {
    target: 'live-dag',
...
export function ChallengeWorkspaceTour({
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="pointer-events-auto absolute right-4 top-14 flex max-w-[calc(100vw-2rem)] items-center gap-2 rounded-full border border-border bg-card/95 px-3 py-2 shadow-panel">
      ...
      {tourSteps.map((step, index) => {
        ...
        return (
          <div
            key={step.target}
            className="pointer-events-auto absolute w-[260px] rounded-lg border border-border bg-card/95 p-3 shadow-panel"
