...
export const challengesApi = {
  ...
  startChallengeRun(trialId: number, input?: { prior_run_id?: number | null; replay?: boolean }) {
    ...
    return apiOperationRequest<'challenge_trials_runs_create', ChallengeRunResponse>(
  ...
  retryChallengeRun(runId: number) {
    return apiOperationRequest<'challenge_runs_retry_create', ChallengeRunResponse>(
