...
import type { ConflictDetail, RepositorySnapshot, RepositoryValue } from '@/features/practice/types'
import {
  buildProjectTree,
  editorContent,
  flattenProjectFiles,
...
import type { ProjectTreeNode, WorkspaceFileInput } from '@/features/practice/utils/projectFiles'
