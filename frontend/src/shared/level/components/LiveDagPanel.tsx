...
import type { RepositoryCommit, RepositorySnapshot, RepositoryValue } from '@/shared/level/types'
...
const NO_DELTA: EnteringDelta = { commits: new Set(), refsByCommit: new Map() }

/** What this command added/moved, for the enter animations. */
function snapshotDelta(prev: RepositorySnapshot, next: RepositorySnapshot): EnteringDelta {
