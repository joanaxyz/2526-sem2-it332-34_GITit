...
>(function SpriteAnimator(
  { animation, scale = 1, fps, autoPlay = true, flipX = false, pixelated = false, className, 'aria-label': ariaLabel },
  ref,
) {
  ...
  return (
    <div
      ...
      style={{
        width: anim.frameWidth * scale,
        height: anim.frameHeight * scale,
